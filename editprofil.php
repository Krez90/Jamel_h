...
////////////////////////Modif code postal/////////////////////////////////////////////////
    if(isset($_POST['codepostal']) AND !empty($_POST['codepostal']) AND $_POST['codepostal'] != $user['code_postal']){
        ...
        $insertcodepostal = $bdd->prepare("UPDATE clients SET code_postal = ? WHERE id = ?");
    ...
    if(isset($_POST['pays']) AND !empty($_POST['pays']) AND $_POST['pays'] != $user['pays']){
        ...
        $insertpays = $bdd->prepare("UPDATE clients SET pays = ? WHERE id = ?");
...
if(isset($_POST['newmdp1']) AND !empty($_POST['newmdp1']) AND isset($_POST['newmdp2']) AND !empty($_POST['newmdp2'])){
    ...
    if($mdp1 == $mdp2){
        $insertmdp = $bdd->prepare("UPDATE clients SET password = ? WHERE id = ?");
